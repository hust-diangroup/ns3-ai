...
PYBIND11_MODULE(ns3ai_ratecontrol_ts_py, m) {
    ...
    py::class_<ns3::NS3AIRL<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>>(m, "NS3AIRL")
        ...
        .def("get_env", &ns3::NS3AIRL<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::get_env)
        .def("set_act", &ns3::NS3AIRL<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::set_act)
