...
PYBIND11_MODULE(ns3ai_ratecontrol_ts_py, m) {
    ...
    py::class_<ns3::Ns3AiMsgInterfaceImpl<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>>(m, "Ns3AiMsgInterfaceImpl")
        ...
        .def("PyRecvBegin",
             &ns3::Ns3AiMsgInterfaceImpl<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::PyRecvBegin)
        .def("PyRecvEnd",
             &ns3::Ns3AiMsgInterfaceImpl<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::PyRecvEnd)
        .def("PySendBegin",
             &ns3::Ns3AiMsgInterfaceImpl<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::PySendBegin)
        .def("PySendEnd",
             &ns3::Ns3AiMsgInterfaceImpl<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::PySendEnd)
        .def("PyGetFinished",
             &ns3::Ns3AiMsgInterfaceImpl<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::PyGetFinished)
        .def("GetCpp2PyStruct",
             &ns3::Ns3AiMsgInterfaceImpl<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::GetCpp2PyStruct,
             py::return_value_policy::reference)
        .def("GetPy2CppStruct",
             &ns3::Ns3AiMsgInterfaceImpl<ns3::AiThompsonSamplingEnvStruct, ns3::AiThompsonSamplingActStruct>::GetPy2CppStruct,
             py::return_value_policy::reference)
        ;
