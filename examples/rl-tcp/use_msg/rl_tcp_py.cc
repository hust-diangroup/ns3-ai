...
PYBIND11_MODULE(ns3ai_rltcp_msg_py, m) {
    ...
    py::class_<ns3::Ns3AiMsgInterface<ns3::TcpRlEnv, ns3::TcpRlAct>>(m, "Ns3AiMsgInterface")
        .def(py::init<bool, bool, bool, uint32_t, const char*, const char*, const char*, const char*>())
        .def("py_recv_begin",
             &ns3::Ns3AiMsgInterface<ns3::TcpRlEnv,
        ...
        .def_readwrite("m_single_cpp2py_msg", &ns3::Ns3AiMsgInterface<ns3::TcpRlEnv, ns3::TcpRlAct>::m_single_cpp2py_msg)
        .def_readwrite("m_single_py2cpp_msg", &ns3::Ns3AiMsgInterface<ns3::TcpRlEnv, ns3::TcpRlAct>::m_single_py2cpp_msg)
        ;
