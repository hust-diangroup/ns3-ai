...
void
MyRrMacScheduler::DoCschedCellConfigReq(
...
void
MyRrMacScheduler::DoCschedUeConfigReq(
...
void
MyRrMacScheduler::DoCschedLcConfigReq(
...
void
MyRrMacScheduler::DoCschedLcReleaseReq(
...
void
MyRrMacScheduler::DoCschedUeReleaseReq(
...
void
MyRrMacScheduler::DoSchedDlRlcBufferReq(
...
void
MyRrMacScheduler::DoSchedDlPagingBufferReq(
...
void
MyRrMacScheduler::DoSchedDlMacBufferReq(
...
bool
MyRrMacScheduler::SortRlcBufferReq(FfMacSchedSapProvider::SchedDlRlcBufferReqParameters i,
...
void
MyRrMacScheduler::DoSchedDlTriggerReq(
...
void
MyRrMacScheduler::DoSchedDlRachInfoReq(
...
void
MyRrMacScheduler::DoSchedDlCqiInfoReq(
            ...
            if (it == m_p10CqiRxed.end())
            {
                ...
                m_p10CqiRxed.insert(
                    std::pair<uint16_t, uint8_t>(rnti,
                                                 cqi_val)); // only codeword 0 at this stage (SISO)
...
void
MyRrMacScheduler::DoSchedUlTriggerReq(
...
void
MyRrMacScheduler::DoSchedUlNoiseInterferenceReq(
...
void
MyRrMacScheduler::DoSchedUlSrInfoReq(
...
void
MyRrMacScheduler::DoSchedUlMacCtrlInfoReq(
...
void
MyRrMacScheduler::DoSchedUlCqiInfoReq(
